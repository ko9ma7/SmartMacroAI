...
[![Version](https://img.shields.io/badge/version-v1.4.0-blue?style=for-the-badge&logo=windows)](https://github.com/TroniePh/SmartMacroAI/releases)
...
1. Tải file `SmartMacroAI_Setup_v1.4.0.exe` từ [**Releases**](https://github.com/TroniePh/SmartMacroAI/releases/latest)
...
4. File cài đặt nằm tại `installer_out\SmartMacroAI_Setup_v1.4.0.exe`.
